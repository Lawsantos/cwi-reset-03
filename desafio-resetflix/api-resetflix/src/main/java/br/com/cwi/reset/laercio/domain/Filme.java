...
public class Filme {
    ...
    public Filme(String nome, Integer anoLancamento, String capaFilme, List<Genero> generos, Optional<Estudio> estudio, Diretor diretor, List<PersonagemAtor> personagens, String resumo) {
    }
